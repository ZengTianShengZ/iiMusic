 ...
 */
public class EuclidActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rootview = inflater.inflate(R.layout.activity_euclid, container, false);

        context = rootview.getContext();

        mWrapper = (RelativeLayout) rootview.findViewById(R.id.wrapper);
        mListView = (ListView) rootview.findViewById(R.id.list_view);
        mToolbar = (FrameLayout) rootview.findViewById(R.id.toolbar_list);
        mToolbarProfile = (RelativeLayout) rootview.findViewById(R.id.toolbar_profile);
        mProfileDetails = (LinearLayout) rootview.findViewById(R.id.wrapper_profile_details);
        mTextViewProfileName = (TextView) rootview.findViewById(R.id.text_view_profile_name);
        mTextViewProfileDescription = (TextView) rootview.findViewById(R.id.text_view_profile_description);
        mButtonProfile = rootview.findViewById(R.id.button_profile);
        ...
        rootview.findViewById(R.id.toolbar_profile_back).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void addOverlayListItem(Map<String, Object> item, View view) {
        if (mOverlayListItemView == null) {
            mOverlayListItemView = rootview.inflate(context,R.layout.overlay_list_item, mWrapper);
        } else {
   ...
   /* private SupportAnimator getAvatarRevealAnimator() {
    ...
    private Animator getOpenProfileToolbarAnimator() {
        Animator mOpenProfileToolbarAnimator = ObjectAnimator.ofFloat(mToolbarProfile, View.Y, -mToolbarProfile.getHeight()*2, -mToolbarProfile.getHeight());
...
/*    @Override
    ...
    protected  BaseAdapter getAdapter(){
        ...
        return new EuclidListAdapter(context, R.layout.list_item, profilesList);
    }
